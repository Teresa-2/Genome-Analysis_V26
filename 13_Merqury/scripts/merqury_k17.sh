...
#SBATCH -J merqury_k17
#SBATCH -N 1
#SBATCH -n 2
#SBATCH -t 3:00:00
#SBATCH --output=merqury_k17_%j.out
#SBATCH --error=merqury_k17_%j.err
...
OUTDIR="merqury_output_k17"
OUTPUT_PREFIX="merqury_out_k17"
K=17
...
echo "[$(date)] Step 2: running Merqury (k=$K)"
